  ...
  void initState() {
    ...
    if (!kReleaseMode) {
      ...
      _textEditingController.text =
          'http://shuyuan.miaogongzi.net/shuyuan/1627741986.json';
    }
  }
            ...
            children: [
              Row(
                children: [
                  ...
                  if (isLandscape) _buildBtnLayout(theme, context),
                ],
              ),
              if (!isLandscape) Center(child: _buildBtnLayout(theme, context)),
              Expanded(
  ...
  dynamic _fromNetWork() async {
    ...
    try {
      var req = await Dio(BaseOptions(responseType: ResponseType.plain))
          .get(_textEditingController.text.trim());
